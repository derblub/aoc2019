...
LANGUAGES=( go   scala  ruby perl    elixir rust  d    fortran nim cobol racket)
DONE=(swift haskell dart c++ elm haxe kotlin pascal erlang assembly php javascript bash python)
