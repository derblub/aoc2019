...
LANGUAGES=( go  haskell scala  ruby perl    elixir rust  d  swift  fortran nim cobol racket)
DONE=(dart c++ elm haxe kotlin pascal erlang assembly php javascript bash python)
