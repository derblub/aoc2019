...
LANGUAGES=( go c++ haskell scala  ruby perl   dart elixir rust  d  swift  fortran nim cobol racket)
DONE=(elm haxe kotlin pascal erlang assembly php javascript bash python)
