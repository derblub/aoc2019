...
LANGUAGES=( go c++ haskell scala kotlin ruby perl pascal  dart elixir rust haxe d  swift elm fortran nim cobol racket)
DONE=(erlang assembly php javascript bash python)
