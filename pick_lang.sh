...
LANGUAGES=( go c++ haskell scala  ruby perl   dart elixir rust  d  swift elm fortran nim cobol racket)
DONE=(haxe kotlin pascal erlang assembly php javascript bash python)
