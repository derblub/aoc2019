...
LANGUAGES=( go   scala  ruby perl       d    fortran nim cobol racket)
DONE=(elixir rust swift haskell dart c++ elm haxe kotlin pascal erlang assembly php javascript bash python)
