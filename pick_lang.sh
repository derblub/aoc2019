...
LANGUAGES=( go c++ haskell scala kotlin ruby perl pascal  dart elixir rust haxe d erlang swift elm fortran nim cobol racket)
DONE=(assembly php javascript bash python)
